export const ERRORS = {
    ...
    HWID_ALREADY_BLOCKED: {
        code: 'A231',
        message: 'HWID is already blocked',
        httpCode: 409,
    },
    HWID_IS_BLOCKED: {
        code: 'A236',
        message: 'HWID is blocked',
        httpCode: 403,
    },
    HWID_BLOCK_NOT_FOUND: {
        code: 'A232',
        message: 'HWID block not found',
        httpCode: 404,
    },
    GET_BLOCKED_HWIDS_ERROR: {
        code: 'A233',
        message: 'Get blocked HWIDs error',
        httpCode: 500,
    },
    BLOCK_HWID_ERROR: {
        code: 'A234',
        message: 'Block HWID error',
        httpCode: 500,
    },
    UNBLOCK_HWID_ERROR: {
        code: 'A235',
        message: 'Unblock HWID error',
        httpCode: 500,
    },
    GET_DEVICES_BY_HWID_ERROR: {
        code: 'A236',
        message: 'Get devices by HWID error',
        httpCode: 500,
    },
    GET_TELEGRAM_NOTIFICATION_ROUTES_ERROR: {
        code: 'A237',
        message: 'Get Telegram notification routes error',
        httpCode: 500,
    },
    UPDATE_TELEGRAM_NOTIFICATION_ROUTES_ERROR: {
        code: 'A238',
        message: 'Update Telegram notification routes error',
        httpCode: 500,
    },
    CREATE_TELEGRAM_NOTIFICATION_TOPICS_ERROR: {
        code: 'A239',
        message: 'Create Telegram notification topics error',
        httpCode: 500,
    },
    TELEGRAM_NOTIFICATIONS_NOT_ENABLED: {
        code: 'A240',
        message: 'Telegram notifications are not enabled',
        httpCode: 400,
    },
    TELEGRAM_NOTIFICATION_ROUTES_CHAT_ID_REQUIRED: {
        code: 'A241',
        message: 'Chat ID is required to create forum topics',
        httpCode: 400,
        withMessage: (message: string) => ({
            code: 'A241',
            message,
    ...
    GET_DATABASE_BACKUP_SETTINGS_ERROR: {
        code: 'A242',
        message: 'Get database backup settings error',
        httpCode: 500,
    },
    UPDATE_DATABASE_BACKUP_SETTINGS_ERROR: {
        code: 'A243',
        message: 'Update database backup settings error',
        httpCode: 500,
    },
    RUN_DATABASE_BACKUP_ERROR: {
        code: 'A244',
        message: 'Run database backup error',
        httpCode: 500,
    },
    DATABASE_BACKUP_ALREADY_RUNNING: {
        code: 'A245',
        message: 'Database backup is already running',
        httpCode: 409,
    },
    DATABASE_BACKUP_TELEGRAM_NOT_CONFIGURED: {
        code: 'A246',
        message: 'Telegram backup routes are not configured',
        httpCode: 400,
    },
    DATABASE_MANAGEMENT_ELEVATION_REQUIRED: {
        code: 'A250',
        message: 'Database management elevation required',
        httpCode: 403,
    },
    DATABASE_MANAGEMENT_INVALID_CODE: {
        code: 'A251',
        message: 'Invalid database management verification code',
        httpCode: 401,
    },
    DATABASE_MANAGEMENT_CODE_EXPIRED: {
        code: 'A252',
        message: 'Database management verification code expired',
        httpCode: 401,
    },
    DATABASE_MANAGEMENT_TELEGRAM_NOT_CONFIGURED: {
        code: 'A253',
        message: 'Telegram backup secrets topic is not configured',
        httpCode: 400,
    },
    GET_DATABASE_MANAGEMENT_GATE_STATUS_ERROR: {
        code: 'A254',
        message: 'Get database management gate status error',
        httpCode: 500,
    },
    REQUEST_DATABASE_MANAGEMENT_CODE_ERROR: {
        code: 'A255',
        message: 'Request database management verification code error',
        httpCode: 500,
    },
    VERIFY_DATABASE_MANAGEMENT_CODE_ERROR: {
        code: 'A256',
        message: 'Verify database management verification code error',
        httpCode: 500,
    },
    VERIFY_DATABASE_MANAGEMENT_PASSWORD_ERROR: {
        code: 'A257',
        message: 'Verify database management password error',
        httpCode: 500,
    },
    VERIFY_DATABASE_MANAGEMENT_PASSKEY_ERROR: {
        code: 'A258',
        message: 'Verify database management passkey error',
        httpCode: 500,
    },
    GET_DATABASE_MANAGEMENT_ARCHIVES_ERROR: {
        code: 'A259',
        message: 'Get database management archives error',
        httpCode: 500,
    },
    POSTGRES_MANAGEMENT_ELEVATION_REQUIRED: {
        code: 'A260',
        message: 'PostgreSQL management elevation required',
        httpCode: 403,
    },
    POSTGRES_MANAGEMENT_INVALID_CODE: {
        code: 'A261',
        message: 'Invalid PostgreSQL management verification code',
        httpCode: 403,
    },
    POSTGRES_MANAGEMENT_CODE_EXPIRED: {
        code: 'A262',
        message: 'PostgreSQL management verification code expired',
        httpCode: 403,
    },
    POSTGRES_MANAGEMENT_TELEGRAM_NOT_CONFIGURED: {
        code: 'A263',
        message: 'Telegram backup secrets topic is not configured',
        httpCode: 503,
    },
    GET_POSTGRES_MANAGEMENT_GATE_STATUS_ERROR: {
        code: 'A264',
        message: 'Get PostgreSQL management gate status error',
        httpCode: 500,
    },
    REQUEST_POSTGRES_MANAGEMENT_CODE_ERROR: {
        code: 'A265',
        message: 'Request PostgreSQL management code error',
        httpCode: 500,
    },
    VERIFY_POSTGRES_MANAGEMENT_CODE_ERROR: {
        code: 'A266',
        message: 'Verify PostgreSQL management code error',
        httpCode: 500,
    },
    VERIFY_POSTGRES_MANAGEMENT_PASSWORD_ERROR: {
        code: 'A267',
        message: 'Verify PostgreSQL management password error',
        httpCode: 500,
    },
    VERIFY_POSTGRES_MANAGEMENT_PASSKEY_ERROR: {
        code: 'A268',
        message: 'Verify PostgreSQL management passkey error',
        httpCode: 500,
    },
    POSTGRES_SQL_FORBIDDEN: {
        code: 'A269',
        message: 'SQL statement is not allowed',
        httpCode: 403,
    },
    POSTGRES_SQL_CONFIRMATION_REQUIRED: {
        code: 'A270',
        message: 'Telegram confirmation required for this query',
        httpCode: 428,
    },
    POSTGRES_SQL_CONFIRMATION_INVALID: {
        code: 'A271',
        message: 'Invalid query confirmation code',
        httpCode: 403,
    },
    POSTGRES_SQL_CONFIRMATION_EXPIRED: {
        code: 'A272',
        message: 'Query confirmation expired',
        httpCode: 403,
    },
    REQUEST_POSTGRES_SQL_CONFIRMATION_ERROR: {
        code: 'A273',
        message: 'Request PostgreSQL query confirmation error',
        httpCode: 500,
    },
    VERIFY_POSTGRES_SQL_CONFIRMATION_ERROR: {
        code: 'A274',
        message: 'Verify PostgreSQL query confirmation error',
        httpCode: 500,
    },
    EXECUTE_POSTGRES_SQL_ERROR: {
        code: 'A275',
        message: 'Execute PostgreSQL query error',
        httpCode: 500,
    },
    GET_POSTGRES_TABLES_ERROR: {
        code: 'A276',
        message: 'Get PostgreSQL tables error',
        httpCode: 500,
    },
    PREPARE_DATABASE_MANAGEMENT_OAUTH_ERROR: {
        code: 'A277',
        message: 'Prepare database management OAuth elevation error',
        httpCode: 500,
    },
    CONFIRM_DATABASE_MANAGEMENT_OAUTH_ERROR: {
        code: 'A278',
        message: 'Confirm database management OAuth elevation error',
        httpCode: 500,
    },
    PREPARE_POSTGRES_MANAGEMENT_OAUTH_ERROR: {
        code: 'A279',
        message: 'Prepare PostgreSQL management OAuth elevation error',
        httpCode: 500,
    },
    CONFIRM_POSTGRES_MANAGEMENT_OAUTH_ERROR: {
        code: 'A280',
        message: 'Confirm PostgreSQL management OAuth elevation error',
        httpCode: 500,
    },
    GET_USER_ACTIVITY_TIMELINE_ERROR: {
        code: 'A247',
        message: 'Get user activity timeline error',
        httpCode: 500,
    },
    GET_USER_ACTIVITY_TIMELINE_STATS_ERROR: {
        code: 'A248',
        message: 'Get user activity timeline stats error',
        httpCode: 500,
    },
    CREATE_USER_ACTIVITY_EVENT_ERROR: {
        code: 'A249',
        message: 'Create user activity event error',
        httpCode: 500,
    },
} as const;
