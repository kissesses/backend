...
export const REST_API = {
    AUTH: {
        ...
        SESSION: `${ROOT}/${CONTROLLERS.AUTH_CONTROLLER}/${CONTROLLERS.AUTH_ROUTES.SESSION}`,
        LOGOUT: `${ROOT}/${CONTROLLERS.AUTH_CONTROLLER}/${CONTROLLERS.AUTH_ROUTES.LOGOUT}`,
    ...
    HWID: {
        ...
        GET_BLOCKED_HWIDS: `${ROOT}/${CONTROLLERS.HWID_CONTROLLER}/${CONTROLLERS.HWID_ROUTES.GET_BLOCKED_HWIDS}`,
        BLOCK_HWID: `${ROOT}/${CONTROLLERS.HWID_CONTROLLER}/${CONTROLLERS.HWID_ROUTES.BLOCK_HWID}`,
        CHECK_HWID_BLOCKED_STATUS: (hwid: string) =>
            `${ROOT}/${CONTROLLERS.HWID_CONTROLLER}/${CONTROLLERS.HWID_ROUTES.CHECK_HWID_BLOCKED_STATUS(
                hwid,
            )}`,
        UNBLOCK_HWID: (hwid: string) =>
            `${ROOT}/${CONTROLLERS.HWID_CONTROLLER}/${CONTROLLERS.HWID_ROUTES.UNBLOCK_HWID(hwid)}`,
        GET_DEVICES_BY_HWID: (hwid: string) =>
            `${ROOT}/${CONTROLLERS.HWID_CONTROLLER}/${CONTROLLERS.HWID_ROUTES.GET_DEVICES_BY_HWID(
                hwid,
            )}`,
    },
    SUBSCRIPTIONS: {
    ...
    USER_ACTIVITY_TIMELINE: {
        GET: `${ROOT}/${CONTROLLERS.USER_ACTIVITY_TIMELINE_CONTROLLER}/${CONTROLLERS.USER_ACTIVITY_TIMELINE_ROUTES.GET}`,
        STATS: `${ROOT}/${CONTROLLERS.USER_ACTIVITY_TIMELINE_CONTROLLER}/${CONTROLLERS.USER_ACTIVITY_TIMELINE_ROUTES.STATS}`,
    },
    SNIPPETS: {
    ...
    TELEGRAM_NOTIFICATION_ROUTES: {
        GET: `${ROOT}/${CONTROLLERS.TELEGRAM_NOTIFICATION_ROUTES_CONTROLLER}/${CONTROLLERS.TELEGRAM_NOTIFICATION_ROUTES.GET}`,
        UPDATE: `${ROOT}/${CONTROLLERS.TELEGRAM_NOTIFICATION_ROUTES_CONTROLLER}/${CONTROLLERS.TELEGRAM_NOTIFICATION_ROUTES.UPDATE}`,
        CREATE_TOPICS: `${ROOT}/${CONTROLLERS.TELEGRAM_NOTIFICATION_ROUTES_CONTROLLER}/${CONTROLLERS.TELEGRAM_NOTIFICATION_ROUTES.CREATE_TOPICS}`,
    },
    DATABASE_BACKUP: {
        GET: `${ROOT}/${CONTROLLERS.DATABASE_BACKUP_CONTROLLER}/${CONTROLLERS.DATABASE_BACKUP_ROUTES.GET}`,
        UPDATE: `${ROOT}/${CONTROLLERS.DATABASE_BACKUP_CONTROLLER}/${CONTROLLERS.DATABASE_BACKUP_ROUTES.UPDATE}`,
        RUN_NOW: `${ROOT}/${CONTROLLERS.DATABASE_BACKUP_CONTROLLER}/${CONTROLLERS.DATABASE_BACKUP_ROUTES.RUN_NOW}`,
    },
    DATABASE_MANAGEMENT: {
        GATE_STATUS: `${ROOT}/${CONTROLLERS.DATABASE_MANAGEMENT_CONTROLLER}/${CONTROLLERS.DATABASE_MANAGEMENT_ROUTES.GATE_STATUS}`,
        REQUEST_CODE: `${ROOT}/${CONTROLLERS.DATABASE_MANAGEMENT_CONTROLLER}/${CONTROLLERS.DATABASE_MANAGEMENT_ROUTES.REQUEST_CODE}`,
        VERIFY_CODE: `${ROOT}/${CONTROLLERS.DATABASE_MANAGEMENT_CONTROLLER}/${CONTROLLERS.DATABASE_MANAGEMENT_ROUTES.VERIFY_CODE}`,
        VERIFY_PASSWORD: `${ROOT}/${CONTROLLERS.DATABASE_MANAGEMENT_CONTROLLER}/${CONTROLLERS.DATABASE_MANAGEMENT_ROUTES.VERIFY_PASSWORD}`,
        PASSKEY_OPTIONS: `${ROOT}/${CONTROLLERS.DATABASE_MANAGEMENT_CONTROLLER}/${CONTROLLERS.DATABASE_MANAGEMENT_ROUTES.PASSKEY_OPTIONS}`,
        PASSKEY_VERIFY: `${ROOT}/${CONTROLLERS.DATABASE_MANAGEMENT_CONTROLLER}/${CONTROLLERS.DATABASE_MANAGEMENT_ROUTES.PASSKEY_VERIFY}`,
        OAUTH_PREPARE: `${ROOT}/${CONTROLLERS.DATABASE_MANAGEMENT_CONTROLLER}/${CONTROLLERS.DATABASE_MANAGEMENT_ROUTES.OAUTH_PREPARE}`,
        OAUTH_CONFIRM: `${ROOT}/${CONTROLLERS.DATABASE_MANAGEMENT_CONTROLLER}/${CONTROLLERS.DATABASE_MANAGEMENT_ROUTES.OAUTH_CONFIRM}`,
        ARCHIVES: `${ROOT}/${CONTROLLERS.DATABASE_MANAGEMENT_CONTROLLER}/${CONTROLLERS.DATABASE_MANAGEMENT_ROUTES.ARCHIVES}`,
        REVOKE: `${ROOT}/${CONTROLLERS.DATABASE_MANAGEMENT_CONTROLLER}/${CONTROLLERS.DATABASE_MANAGEMENT_ROUTES.REVOKE}`,
    },
    POSTGRES_MANAGEMENT: {
        GATE_STATUS: `${ROOT}/${CONTROLLERS.POSTGRES_MANAGEMENT_CONTROLLER}/${CONTROLLERS.POSTGRES_MANAGEMENT_ROUTES.GATE_STATUS}`,
        REQUEST_CODE: `${ROOT}/${CONTROLLERS.POSTGRES_MANAGEMENT_CONTROLLER}/${CONTROLLERS.POSTGRES_MANAGEMENT_ROUTES.REQUEST_CODE}`,
        VERIFY_CODE: `${ROOT}/${CONTROLLERS.POSTGRES_MANAGEMENT_CONTROLLER}/${CONTROLLERS.POSTGRES_MANAGEMENT_ROUTES.VERIFY_CODE}`,
        VERIFY_PASSWORD: `${ROOT}/${CONTROLLERS.POSTGRES_MANAGEMENT_CONTROLLER}/${CONTROLLERS.POSTGRES_MANAGEMENT_ROUTES.VERIFY_PASSWORD}`,
        PASSKEY_OPTIONS: `${ROOT}/${CONTROLLERS.POSTGRES_MANAGEMENT_CONTROLLER}/${CONTROLLERS.POSTGRES_MANAGEMENT_ROUTES.PASSKEY_OPTIONS}`,
        PASSKEY_VERIFY: `${ROOT}/${CONTROLLERS.POSTGRES_MANAGEMENT_CONTROLLER}/${CONTROLLERS.POSTGRES_MANAGEMENT_ROUTES.PASSKEY_VERIFY}`,
        OAUTH_PREPARE: `${ROOT}/${CONTROLLERS.POSTGRES_MANAGEMENT_CONTROLLER}/${CONTROLLERS.POSTGRES_MANAGEMENT_ROUTES.OAUTH_PREPARE}`,
        OAUTH_CONFIRM: `${ROOT}/${CONTROLLERS.POSTGRES_MANAGEMENT_CONTROLLER}/${CONTROLLERS.POSTGRES_MANAGEMENT_ROUTES.OAUTH_CONFIRM}`,
        TABLES: `${ROOT}/${CONTROLLERS.POSTGRES_MANAGEMENT_CONTROLLER}/${CONTROLLERS.POSTGRES_MANAGEMENT_ROUTES.TABLES}`,
        ANALYZE_QUERY: `${ROOT}/${CONTROLLERS.POSTGRES_MANAGEMENT_CONTROLLER}/${CONTROLLERS.POSTGRES_MANAGEMENT_ROUTES.ANALYZE_QUERY}`,
        REQUEST_CONFIRMATION: `${ROOT}/${CONTROLLERS.POSTGRES_MANAGEMENT_CONTROLLER}/${CONTROLLERS.POSTGRES_MANAGEMENT_ROUTES.REQUEST_CONFIRMATION}`,
        VERIFY_CONFIRMATION: `${ROOT}/${CONTROLLERS.POSTGRES_MANAGEMENT_CONTROLLER}/${CONTROLLERS.POSTGRES_MANAGEMENT_ROUTES.VERIFY_CONFIRMATION}`,
        EXECUTE_QUERY: `${ROOT}/${CONTROLLERS.POSTGRES_MANAGEMENT_CONTROLLER}/${CONTROLLERS.POSTGRES_MANAGEMENT_ROUTES.EXECUTE_QUERY}`,
        REVOKE: `${ROOT}/${CONTROLLERS.POSTGRES_MANAGEMENT_CONTROLLER}/${CONTROLLERS.POSTGRES_MANAGEMENT_ROUTES.REVOKE}`,
    },
